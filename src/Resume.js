...
class Resume extends Component{
  render(){
    return(<React.Fragment>
      <Header/>
      <div className="aaa1">  
  <h1 className="aaa2">Resume Templates</h1>
         
  <h2  className="aaa3">Pick a resume template, fill it out, and format. Create a professional resume<br/> in a few clicks. Just choose one of 18+ resume templates below, add ready<br/>-made content, download, and get the job.</h2>
  </div>
  <div className = "aaa4">
            <div><Link to = '/Resume' exact className="aaa5">Resume templates</Link> </div> 
           <div> <Link to = '/Cover' exact className="aaa5">Cover letter templates</Link> </div> 
            <div> <Link to = '/Cv' exact className="aaa5">CV templates</Link > </div>
            <div> <Link to = '/All' exact className="aaa6 active">All</Link > </div>
             </div> 
             
  <div className="aaa10"> 
    <div className = "aaa7"> 
      <div className="aaa12">
      <Link to = '/Recreat' exact className="resume-btn">USE THIS TEMPLATE</Link >
      </div>
  ...
  <div className="aaa15">
  <img  className="aaa14" src = { process.env.PUBLIC_URL + '/image10.png' }/>
  <div className="aaa16"><h1 >Best resume templatesfor a job or academia</h1>
  ...
  <div className="aaa17">
  <img  className="aaa18" src = { process.env.PUBLIC_URL + '/image11.png' }/>
  <div className="aaa19"><h1 >Attractive design</h1>
  ...
  <div className="aaa22">
  <img  className="aaa20" src = { process.env.PUBLIC_URL + '/image12.jpg' }/>
  <div className="aaa21"><h1 >Ease of use</h1>
  ...
  <div className="aaa23">
  <img  className="aaa24" src = { process.env.PUBLIC_URL + '/image14.png' }/>
  <div className="aaa21"><h1 >Confidence boost</h1>
