  ...
  render() {
    return (
      <React.Fragment>
        <Header />
        <div className="bbb1">
          <h1 className="bbb2">Cover Letter Templates</h1>

          <h2 className="bbb3">Click on a cover letter template, fill it online, and download in seconds. Build<br /> a professional cover letter in a few clicks. Just pick one of 18+ cover letter<br /> templates below, add ready-made content, and get the job.</h2>
        </div>

        <div className="bbb4">
          <div><Link to='/Resume' exact className="bbb5">Resume templates</Link> </div>
          <div> <Link to='/Cover' exact className="bbb5">Cover letter templates</Link> </div>
          <div> <Link to='/Cv' exact className="bbb5">CV templates</Link > </div>
          <div> <Link to='/All' exact className="bbb6">All</Link > </div>
        </div>
        ...
        <div className="bbb15">
          <img className="bbb14" src={process.env.PUBLIC_URL + '/image10.png'} />
          <div className="bbb16"><h1 >Best resume templatesfor a job or academia</h1>
        ...
        <div className="bbb17">
          <img className="bbb18" src={process.env.PUBLIC_URL + '/image11.png'} />
          <div className="bbb19"><h1 >Attractive design</h1>
        ...
        <div className="bbb22">
          <img className="bbb20" src={process.env.PUBLIC_URL + '/image12.jpg'} />
          <div className="bbb21"><h1 >Ease of use</h1>
        ...
        <div className="bbb23">
          <img className="bbb24" src={process.env.PUBLIC_URL + '/image14.png'} />
          <div className="bbb21"><h1 >Confidence boost</h1>
